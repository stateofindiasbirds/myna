...
app.get("/api/users/all_years_count",UserController.graph); 
...
describe('(State,County) Data Contributions ID-T016', () => {
  ...
  it('T016/effortsDetails', async () => {
    ...
    expect(response.body).toEqual({
      "data": {
        "numberOfObservations": 9526,
        "numberOfList": "675",
        "numberOfUniqueLists": "584",
        "totalNumberOfHours": 470,
...
describe('(State,County) Bar Chart ID-T017', () => {

    it('T017/all_years_count', async () => {
