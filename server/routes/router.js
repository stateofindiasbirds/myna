...
router.get("/percentage_endemic_species", cacheMiddleware(cacheKeyGenerator), UserController.endemincSpecies);
router.get(
  "/pertcentage_most_common_species",
  cacheMiddleware(cacheKeyGenerator),
  UserController.mostCommonSpecies
);
router.get("/seasonal_chart_for_species", cacheMiddleware(cacheKeyGenerator), UserController.seasonalChart);
router.get("/hotspot_area", cacheMiddleware(cacheKeyGenerator), UserController.hotspotArea);
...
router.get("/water_bird_congregation", cacheMiddleware(cacheKeyGenerator), UserController.waterBirdCongregations);
