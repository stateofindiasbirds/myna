...
describe('(State, County and Locality) Location Name ID-T5018', () => {

  //Controller locationName state and county
  it('T5018/location_listing', async () => {
...
describe('(State, County and Locality) Species Details ID-T5019', () => {

  it('T5019/count_by_scientificName', async () => {
...
describe('(State, County and Locality) IUCN Red List Species ID-T5020', () => {

    it('T5020/percentage_iucn_redList_species', async () => {
  ...
  describe('(State, County and Locality) Endemic Species ID-T5021', () => {
    it('T5021/percentage_endemic_species', async () => {
  ...
  describe('(State, County and Locality) Most Common Species ID-T5022', () => {
    it('T5022/pertcentage_most_common_species', async () => {
  ...
  describe('(State, County and Locality) Seasonal Chart ID-T5023', () => {
    it('T5023/seasonal_chart_for_species', async () => {
  ...
  describe('(State, County and Locality) Hotspots ID-T5024', () => {


    it('T5024/hotspot_area', async () => {
  ...
  describe('(State, County and Locality) Complete List of Species ID-T5025', () => {

    it('T5025/complete_List_Of_Species', async () => {
  ...
  describe('(State, County and Locality) Data Contributions ID-T5027', () => {

    it('T5027/effortsDetails', async () => {
      ...
      expect(response.body).toEqual({
        "data": {
            "numberOfObservations": 387,
            "numberOfList": "37",
            "numberOfUniqueLists": "25",
            "totalNumberOfHours": 24,
            "totalNumberOfObservers": 22
        }
    })
    })
  });