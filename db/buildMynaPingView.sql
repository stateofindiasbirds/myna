-- ============================================
-- Script: buildMynaPingView.sql
-- Purpose: Recreate materialized view "merge_ping"
...
DROP MATERIALIZED VIEW IF EXISTS "merge_ping" CASCADE;

CREATE MATERIALIZED VIEW "merge_ping" AS
